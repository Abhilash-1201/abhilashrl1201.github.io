  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        const mediumRssUrl = "https://medium.com/feed/@abhilashnarayan1201";
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4 mb-4 text-sm text-foreground/70">
                  <div className="flex items-center">
                    ...
                    >
                      medium.com/@abhilashnarayan1201
                    </a>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  {loading ? (
                    ...
                    <ul className="space-y-2 list-disc list-inside">
                      ...
                      <li>
                        <a
                          href="https://medium.com/@abhilashnarayan1201/tofuswitch-simplify-opentofu-version-management-7055f7f696c0"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-yousaf transition-colors"
                        >
                      ...
                      <li>
                        <a
                          href="https://medium.com/@abhilashnarayan1201/domain-monitor-effortlessly-track-your-websites-uptime-348f3ab85844"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-yousaf transition-colors"
                        >
                      ...
                      <li>
                        <a
                          href="https://medium.com/@abhilashnarayan1201/enhancing-security-with-observatory-cli-why-site-score-checks-matter-for-internal-domains-997d57b2c4fc"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-yousaf transition-colors"
                        >
                      ...
                      <li>
                        <a
                          href="https://medium.com/@abhilashnarayan1201/enhancing-kubernetes-deployment-quality-with-kube-score-b21eb8e85fe9"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-yousaf transition-colors"
                        >
